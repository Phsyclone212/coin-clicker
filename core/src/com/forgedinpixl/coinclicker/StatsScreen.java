...
public class StatsScreen extends BaseScreen {
    ...
    public void render(float delta) {
        ...
        statsFont.draw(batch, pointsText, screenWidth / 2f - pointsLayout.width / 2f, statsStartY - lineSpacing);
        statsFont.draw(batch, headsText, screenWidth / 2f - headsLayout.width / 2f, statsStartY - lineSpacing*2);
        statsFont.draw(batch, tailsText, screenWidth / 2f - tailsLayout.width / 2f, statsStartY - lineSpacing*3);
        statsFont.draw(batch, headPercent, screenWidth / 2f - hPercentLayout.width / 2f, statsStartY - lineSpacing*4);
        statsFont.draw(batch, tailsPercent, screenWidth / 2f - tPercentLayout.width / 2f, statsStartY - lineSpacing*5);
        statsFont.draw(batch, currentStreakText, screenWidth / 2f - currentStreakLayout.width / 2f, statsStartY - lineSpacing*6);
        statsFont.draw(batch, historyText, screenWidth / 2f - historyLayout.width / 2f, statsStartY - lineSpacing*7);
        statsFont.draw(batch, longestStreakText, screenWidth / 2f - longestStreakLayout.width / 2f, statsStartY - lineSpacing*8);
        statsFont.draw(batch, streakOddsText, screenWidth / 2f - streaksOddsLayout.width / 2f, statsStartY - lineSpacing*9);
